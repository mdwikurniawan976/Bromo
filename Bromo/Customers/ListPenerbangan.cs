        ...
        private void dataGridView1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            if (dataGridView1.Rows[e.RowIndex].DataBoundItem is JadwalPenerbangan jadwalPenerbangan)
            {
                if (e.ColumnIndex == BeliTiket.Index)
                {
                   ...
                   /* BeliTiket beliTiketForm = new BeliTiket(jumlahpenumpang, bandaraAsal, bandaraTujuan, TanggalKeberangkatan, hargaPertiket, maskapai, waktuPenerbangan ,id, jadwalid);
                    beliTiketForm.Show();
                    this.Hide();*/
                }
            }
